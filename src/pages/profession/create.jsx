...
export const Professionreate = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const response = await NetworkServices.Profession.store(payload)
        ...
        <section className="shadow-md my-5 p-4 px-6">
            <form className="px-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="my-4 flex justify-center">
                    <PrimaryButton loading={loading} name="Profession create"></PrimaryButton>
                </div>
